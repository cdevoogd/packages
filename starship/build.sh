...
download_release_tarball() {
    ...
    local url="https://github.com/starship/starship/releases/download/v$PKG_VERSION/starship-${arch}-unknown-linux-musl.tar.gz"
    log "Downloading starship for $arch: $url"
...
extract_release() {
    ...
    log "Extracting starship release: $tarball"
...
package_release() {
    ...
    log "Packaging starship for $arch"
...
main() {
    ...
    for arch in "${ARCHITECTURES[@]}"; do
        local tarball="$DOWNLOAD_DIR/starship-$arch.tar.gz"
